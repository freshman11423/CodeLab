...
const TurkeyMap = () => {
  ...
  return (
    <View style={styles.container}>
      <Svg
        accessible={true}
        accessibilityLabel="Türkiye haritası"
        width="90%"
        height={400}
      ...
      >
        ...
        <Path
          ...
          stroke="#000"
          strokeWidth={1}
          onPress={() => handlePress('Erzurum')}
        />
        <SvgText x="755" y="305" fontSize="12" fontFamily="Arial">
          Erzurum
        </SvgText>
        ...
        />
        <SvgText x="860" y="345" fontSize="12" fontFamily="Arial">
          Van
        </SvgText>
        ...
        <Path
          ...
          stroke="#000"
          strokeWidth={1}
          onPress={() => handlePress('Malatya')}
        />
        <SvgText x="655" y="365" fontSize="12" fontFamily="Arial">
          Malatya
        </SvgText>
        ...
        <Path
          ...
          stroke="#000"
          strokeWidth={1}
          onPress={() => handlePress('Elazığ')}
        />
        <SvgText x="710" y="325" fontSize="12" fontFamily="Arial">
          Elazığ
        </SvgText>
        ...
        <Path
          ...
          stroke="#000"
          strokeWidth={1}
          onPress={() => handlePress('Ağrı')}
        />
        <SvgText x="810" y="275" fontSize="12" fontFamily="Arial">
          Ağrı
        </SvgText>
      </Svg>
    </View>
